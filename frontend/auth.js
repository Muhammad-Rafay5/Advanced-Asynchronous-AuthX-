...
const authService = {
    ...
    async register(full_name, company_name, email, password, confirm_password, terms_accepted) {
        const response = await fetch(`${API_URL}/auth/register`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ full_name, company_name, email, password, confirm_password, terms_accepted })
        });
    ...
    async resetPassword(token, new_password, confirm_new_password) {
